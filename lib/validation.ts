...
export const ServicesValidationSchema = (t: (arg: string) => string) => z.object({
  ...
  description:  z.string().min(10, {message: t("DESCRIPTION_MIN_LENGTH")}).max(500, {message: t("DESCRIPTION_MAX_LENGTH")} ),
  duration:     z.coerce.number().min(1, {message: t("DURATION_VALIDATION_MESSAGE")}),
